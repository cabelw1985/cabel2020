...
ADDONTITLE     = '[B][COLOR gold]--[COLOR gold]alexwizard[COLOR gold]--[/COLOR][/B]'
BUILDERNAME    = 'alexwizard'
...
UPDATECHECK    = 0
APKFILE        = 'http://pavootv.com/FileWizard/APKFILE%20.xml'
YOUTUBETITLE   = 'http://'
YOUTUBEFILE    = 'http://'
ADDONFILE      = 'https://raw.githubusercontent.com/cabelw1985/cabel2020/master/plugin/textdatei/Repository.txt'
ADVANCEDFILE   = 'http://'
ROMPACK        = 'http://pavootv.com/FileWizard/ADDONFILE.xml'
EMUAPKS        = 'http://'
ADDONPACK      = 'http://'
...
HIDECONTACT    = 'No'
# You can add \n to do line breaks
CONTACT        = 'Thank you for choosing Pavoo Wizard.'
...
NOTIFICATION   = 'http://pavootv.com/repo/wizard/wizardmenu.txt'
# Use either 'Text' or 'Image'
HEADERTYPE     = 'Text'
# Font size of header
FONTHEADER     = 'Font25'
HEADERMESSAGE  = 'Pavoo Wizard'
# url to image if using Image 424x180
HEADERIMAGE    = ''
# Font for Notification Window
FONTSETTINGS   = 'Font12'
# Background for Notification Window
BACKGROUND     = 'http://pavootv.com/repo/wizard/fanart.jpg'
############################    #############################