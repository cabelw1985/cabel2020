...
def speedtest(
    ...
    line1 = '[COLOR lime]Pokretanje..[/COLOR]' 
    dp.create('%s: [COLOR lime]Provjera brzine[/COLOR]' % (ADDONTITLE
             ), line1)
    dp.update(0)
    build_user_agent()
    print_('Retrieving speedtest.net configuration...')
    line2 = \
        '[COLOR lime]Dohvacanje konfiguracije...[/COLOR]' \
    ...
    line3 = '[COLOR lime]Dohvacanje server liste...[/COLOR]' \
    ...
    line1 = '[COLOR lime]Testiranje:[/COLOR] [COLOR white]%(isp)s (%(ip)s)[/COLOR]' % config['client']
    dp.update(6, line1)

    print_('Selecting best server based on latency...')
    line2 = \
        '[COLOR lime]Odabir najboleg servera prema latenciji...[/COLOR]' \
    ...
    line2 = ('[COLOR lime]Lokacija:[/COLOR] [COLOR white]%(name)s [%(d)0.2f km]: %(latency)s ms[/COLOR]'
              % best).encode('utf-8', 'ignore')
    dp.update(10, '', line2)
    ...
    line3 = '[COLOR lime]Brzina preuzimanja...[/COLOR]' 
    dp.update(15, '', '', line3)
    dlspeed = downloadSpeed(urls, simple)

    print_()
    print_('Preuzimanje: %0.2f M%s/s' % (dlspeed / 1000 / 1000 * units[1],
           units[0]))
    ...
    print_('[COLOR lime]Provjera brzine slanja[/COLOR]', end='')
    line2 = \
        '[COLOR lime]Brzina preuzimanja:[/COLOR] [COLOR white]%0.2f M%s/s[/COLOR]' \
        % ( dlspeed / 1000 / 1000 * units[1], units[0])
    line3 = '[COLOR lime]Brzina slanja...[/COLOR]' 
    ...
    line1 = line2
    line2 = \
        '[COLOR lime]brzina slanja::[/COLOR] [COLOR white]%0.2f M%s/s[/COLOR]' \
        % ( ulspeed / 1000 / 1000 * units[1], units[0])
    line3 = '[COLOR orange lime]Dohvacanje podataka...[/COLOR]' 
