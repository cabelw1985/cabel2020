...
ORDER          = ['lastship', 'exodusredux', 'yoda', 'covenant', 'exodus', 'flixnet', 'incursion', 'placenta', 'genesisreborn', 'showboxarize', 'gurzil', 'url']
...
DEBRIDID = { 
	...
	'exodusredux': {
		...
		'file'     : os.path.join(REALFOLD, 'exodusredux_debrid'),
		'settings' : os.path.join(ADDOND, 'plugin.video.exodusredux', 'settings.xml'),
		'default'  : 'realdebrid.id',
		'data'     : ['realdebrid.auth', 'realdebrid.id', 'realdebrid.secret', 'realdebrid.token', 'realdebrid.refresh'],
		'activate' : 'RunPlugin(plugin://plugin.video.exodusredux/?action=rdAuthorize)'},
	'yoda': {
		'name'     : 'Yoda',
		...
		'file'     : os.path.join(REALFOLD, 'yoda_debrid'),
		'settings' : os.path.join(ADDOND, 'plugin.video.Yoda', 'settings.xml'),
		'default'  : 'realdebrid.id',
		'data'     : ['realdebrid.auth', 'realdebrid.id', 'realdebrid.secret', 'realdebrid.token', 'realdebrid.refresh'],
		'activate' : 'RunPlugin(plugin://plugin.video.Yoda/?action=rdAuthorize)'},	
	'covenant': {
		'name'     : 'Covenant',
