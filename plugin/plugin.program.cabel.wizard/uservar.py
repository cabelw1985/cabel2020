...
ADDONTITLE     = '[COLOR=lime]Cabel[/COLOR] [COLOR=white]Wizard[/COLOR]'
BUILDERNAME    = '[COLOR=lime]Cabel[/COLOR] [COLOR=white]Wizard[/COLOR]'
...
WIZTITLE = '[COLOR=lime]Cabel Green[/COLOR] [COLOR=white]Wizard[/COLOR]'
...
# Font size of header
FONTHEADER     = 'Font25'
HEADERMESSAGE  = '[COLOR=lime]Cabel Green[/COLOR] [COLOR=white]Wizard[/COLOR]'
